...
readMoreBtn.addEventListener("click", () => {
  ...
  if (isHidden) {
    ...
    // Для 430px: вставить картинку перед кнопкой, чтобы она была под всем текстом
    if (window.innerWidth === 430) {
      servicesText.insertBefore(imgCps, readMoreBtn);
    }
  } else {
    moreText.style.display = "none";
    ...
    // Для 430px: вернуть картинку перед основным текстом
    if (window.innerWidth === 430) {
